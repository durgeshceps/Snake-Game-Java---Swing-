...
public class Board extends JPanel implements ActionListener {
    ...
    private final int RANDOM_POSITION = BOARD_WIDTH / DOT_SIZE; // 30
    ...
    public void draw(Graphics g) {
        if (inGame) {
            ...
            g.setFont(new Font("SAN_SERIF", Font.PLAIN, 12));
    ...
    public void gameOver(Graphics g) {
        ...
        g.drawString(msg2, (BOARD_WIDTH - metrics.stringWidth(msg2)) / 2, BOARD_HEIGHT / 2 + 20);
    }
